...
<div class="col-sm-8 offset-md-2">
    <h4 align="center">Pedido Concluído Com Sucesso!</h4><br>
    ...
    <div class="row">
        <div class="col-sm-7">
            ...
            <p>VALOR TOTAL: <code>R$ <?php echo $_SESSION['valor']; ?></code></p>
        </div>

        <div class="col-sm-5">
            <h5>Efetue o Pagamento:</h5>
            <hr>
            <small class="text-success">Dados Preenchidos com Sucesso, conclua o pagamento!</small>
            <hr>
            <a target="_blank" href="<?php echo $preference["response"]["init_point"]; ?>" name="MP-Checkout" class="orange-ar-m-sq-arall">
                <input type="submit" value="Concluir Pagamento" class="btn btn-outline-success btn-lg btn-block"></a>
